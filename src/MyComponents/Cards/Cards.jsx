    ...
    return (
        ...
        <div className='md:flex mb-5'>
            ...
            <div className='flex flex-col items-center'>
                <p className='text-gray-400 font-semibold text-sm flex text-left justify-center w-56 mt-5 md:mt-28 md:text-xl tracking-widest -ml-5 md:-ml-96 md:w-full md:mr-10'>WHY CHOOSE US?</p>
