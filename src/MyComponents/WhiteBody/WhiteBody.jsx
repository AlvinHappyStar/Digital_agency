        ...
        <>
            <div>
                <div className='flex flex-col items-center'>
                    <p className='text-gray-400 font-semibold text-sm flex text-left justify-center w-56 mt-5 md:mt-28 md:text-xl tracking-widest -ml-5 md:w-full md:mr-10'>GROW OUR SERVICE &amp; INCREASE REVENUE</p>
